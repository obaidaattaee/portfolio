...
<div class="card card-body">
	<h1>اضافة دور حكومي جديد </h1>

	<center>
		<form action="{{ route('goverment.save') }}" method="post" enctype="multipart/form-data">
			@csrf
{{--{{ dd($settings) }}--}}
		<div class="col-sm-6" style="text-align: right;">
                <div class="card">
                  <div class="card-header">اضافة دور حكومي  جديد</div>
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      <label for="street">صورة معبرة عن دور الحكومة</label>
