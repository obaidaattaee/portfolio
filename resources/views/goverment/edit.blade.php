...
<div class="card card-body">
    <h1>التعديل على عنصر دور حكومي </h1>

	<center>
		<form action="{{ route('goverment.update' , ['chance' => $chance->id]) }}" method="post" enctype="multipart/form-data">
			@csrf
{{--{{ dd($settings) }}--}}
		<div class="col-sm-6" style="text-align: right;">
                <div class="card">
                  <div class="card-header">تعديل على عنصر دور الحكومة</div>
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      <label for="street">صورة معبرة عن دور الحكومة في انترنت الاشياء</label>
